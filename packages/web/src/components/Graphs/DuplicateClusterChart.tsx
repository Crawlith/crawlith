  ...
  return (
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 shadow-sm h-full flex flex-col">
      <div className="flex items-center mb-4">
        <h3 className="font-bold text-slate-900 dark:text-slate-100 text-sm">Duplicate Cluster Sizes</h3>
        <Tooltip content="Groups of pages that have near-identical content. Larger clusters can dilute ranking signals and waste crawl budget." />
      </div>
