...
import { ClusterInfo } from './types.js';
...
export class ClusteringService {
    ...
    public detectContentClusters(
        ...
        clusters.forEach((memberUrls, index) => {
            ...
            // In the plugin world, we might not want to mutate the graph nodes directly
            // but we'll return the cluster info and let the plugin handle storage.
            // However, some core components might still expect node.clusterId for now.
